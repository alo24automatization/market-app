        ...
        <>
            ...
            ))}
            {
                !isMobile && <tr className='tr'>
                    ...
                    <td className='text-left td py-[0.625rem] font-bold'>
                        {currency === 'USD'
                            ? data.reduce((prev, el) => prev + (el.cash < 0 || el.card < 0 || el.transfer < 0 ? (el.cash + el.card + el.transfer) : 0), 0).toLocaleString('ru-RU')
                            : data.reduce((prev, el) => prev + (el.cash < 0 || el.card < 0 || el.transfer < 0 ? (el.cashuzs + el.carduzs + el.transferuzs) : 0), 0).toLocaleString('ru-RU')
                        }{' '}
                        {currency}
                    </td>
                    <td className='py-[0.375rem] td border-r-0'>
