...
module.exports.register = async (req, res) => {
    try {
        ...
        const products = await Product.find({
            ...
            .sort({code: -1})
            .select("total market category minimumcount width height metrOfProduct metrIncPriceOfProduct totalMetrOfProduct metrPriceOfProduct")
            .populate(
                "price",
                "incomingprice sellingprice incomingpriceuzs sellingpriceuzs tradeprice tradepriceuzs"
            )
...
module.exports.update = async (req, res) => {
    try {
        ...
        const products = await Product.find({
            ...
            .sort({code: 1})
            .select("total market category minimumcount width height metrOfProduct totalMetrOfProduct metrPriceOfProduct")
            .populate(
                "price",
                "incomingprice sellingprice incomingpriceuzs sellingpriceuzs tradeprice tradepriceuzs"
            )
...
module.exports.getProducts = async (req, res) => {
    try {
        ...
        const products = await Product.find({
            ...
            .sort({code: 1})
            .select("total market category minimumcount connections width height metrIncPriceOfProduct metrOfProduct totalMetrOfProduct metrPriceOfProduct")
            .populate(
                "price",
                "incomingprice sellingprice incomingpriceuzs sellingpriceuzs tradeprice tradepriceuzs"
            )
