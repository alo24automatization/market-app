const { Connection, validateConnection } = require('../models/Connections/Connection');
...
const { Exchangerate, validateExchangerate } = require('../models/Exchangerate/Exchangerate');
