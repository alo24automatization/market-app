...
const market = new Schema(
    {
        ...
        director: {type: Schema.Types.ObjectId, ref: 'User', index: true},
        market: {type: Schema.Types.ObjectId, ref: 'Market'},
        mainmarket: {type: Schema.Types.ObjectId, ref: 'Market', index: true},
        filials: [{type: Schema.Types.ObjectId, ref: 'Market', index: true}],
