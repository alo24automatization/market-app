...
const user = new Schema(
  {
    ...
    market: { type: Schema.Types.ObjectId, ref: 'Market', index: true }, // o'zini marketi
    type: { type: String, required: true },
    users: [{ type: Schema.Types.ObjectId, ref: 'User', index: true }], // Xodimlar
    user: { type: Schema.Types.ObjectId, ref: 'User', index: true }, // Director
    isIncomePage: { type: Boolean },
    isArchive: { type: Boolean, default: false },
    administrator: { type: Schema.Types.ObjectId, ref: 'User', index: true },
  },
  {
    timestamps: true,
  },
