    ...
    try {
        ...
        for (const category of categories) {
            const products = await Product.find(
                ...
                .sort({timestamp: -1})
                .select("market total productdata price category unit width height minimumcount metrOfProduct metrIncPriceOfProduct totalMetrOfProduct metrPriceOfProduct")
